        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="index.html" class="b-brand">
                    <img src="https://kafil.uz/assets/foto/logo.svg" alt="" class="logo logo-lg" width="150px">
                    <img src="/admin/assets/images/ktext.png" alt="" class="logo logo-sm">
                </a>
            </div>
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu" style="display: none;">
                            <li class="nxl-item"><a class="nxl-link" href="dashboard">Home</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="orders">Order</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
            ...
            <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 598px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div>
        </div>
    </nav>