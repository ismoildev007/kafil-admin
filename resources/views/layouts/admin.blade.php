...
<head>
    ...
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/admin/assets/images/ktext.png') }}">
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/admin/assets/vendors/css/reset.css') }}">
